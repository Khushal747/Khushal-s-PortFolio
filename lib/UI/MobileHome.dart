          ...
          child: Column(
            children: [
              UserAccountsDrawerHeader(
                  ...
                  accountName: Text("Khushal Verma"),
                  accountEmail: Text("khushal7477@gmail.com")),
              ListTile(
                title: Text("Share"),
            ...
            children: [
              ...
              Padding(
                ...
                child: Wrap(
                  children: [
                    Text(
                      "I'm an engineering student, IN specializing in building (and occasionally designing) exceptional websites, applications, and everything in between.",
                      style: TextStyle(
                        color: Colors.grey,
                        fontSize: 15.0,
                        letterSpacing: 2.75,
                    ...
                    children: [
                      ...
                      Wrap(
                        children: [
                          ...
                          CustomText(
                            text:
                                "Shortly currently, I am pursuing my Bachelor's degree in Computer science and Engineering at SVVV University of Indore, as well as doing internship  where I work on a wide variety of interesting and meaningful projects on a daily basis.\n",
                            textsize: 16.0,
                            color: Color(0xff828DAA),
                            fontWeight: FontWeight.w500,
                            letterSpacing: 0.75,
                  ...
                  child: Stack(
                    children: [
                      ...
                      Container(
                        ...
                        child: Image(
                          fit: BoxFit.cover,
                          image: AssetImage("images/Selfprof.jpeg"),
                        ),
                      ),
                      Container(
                        height: size.height * 0.5,
              ...
              Container(
                ...
                //color: Colors.white,
                child: Text(
                  "Designed & Built by Khushal Verma 💙 Flutter",
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    color: Colors.white.withOpacity(0.4),
                    letterSpacing: 1.75,
